...
// testPacketDot11ProbeReq is the packet:
//   21:17:03.838004 Probe Request () [1.0 2.0 5.5 11.0 Mbit][|802.11]
//   	0x0000:  0000 2000 6900 0000 0200 1400 0000 0000  ....i...........
//   	0x0010:  0000 0000 0100 0200 8009 a000 0000 a700  ................
//   	0x0020:  4000 0000 ffff ffff ffff a86b ad3e 7ea6  @..........k.>~.
//   	0x0030:  ffff ffff ffff 3062 0000 0104 0204 0b16  ......0b........
//   	0x0040:  3208 0c12 1824 3048 606c 2d1a 2c11 19ff  2....$0H`l-.,...
//   	0x0050:  0000 0000 0000 0000 0000 0000 0000 0000  ................
//   	0x0060:  0000 0000 0000 0301 06dd 0900 1018 0200  ................
//   	0x0070:  0004 0000 dd1e 0090 4c33 2c11 19ff 0000  ........L3,.....
//   	0x0080:  0000 0000 0000 0000 0000 0000 0000 0000  ................
//   	0x0090:  0000 0000                                ....
var testPacketDot11ProbeReq = []byte{
	,
}
func TestPacketDot11ProbeReq(t *testing.T) {
	p := gopacket.NewPacket(testPacketDot11ProbeReq, LinkTypeIEEE80211Radio, gopacket.Default)
	if p.ErrorLayer() != nil {
		t.Error("Failed to decode packet:", p.ErrorLayer().Error())
	}
	expectedLayers := []gopacket.LayerType{LayerTypeRadioTap, LayerTypeDot11, LayerTypeDot11MgmtProbeReq}
	for i := 0; i < 7; i++ {
		expectedLayers = append(expectedLayers, LayerTypeDot11InformationElement)
	}
	checkLayers(p, expectedLayers, t)
}
func BenchmarkDecodePacketDot11ProbeReq(b *testing.B) {
	for i := 0; i < b.N; i++ {
		gopacket.NewPacket(testPacketDot11ProbeReq, LinkTypeIEEE80211Radio, gopacket.NoCopy)
	}
}


// testPacketDot11ProbeResponse is the packet:
//   12:56:59.629660 92606716140us tsft 1.0 Mb/s 2462 MHz 11b -38dBm signal antenna 0 [bit 22] Probe Response (Choose Another Castle) [1.0* 2.0* 5.5* 11.0* 6.0 9.0 12.0 18.0 Mbit] CH: 11, PRIVACY
//   	0x0000:  0000 2c00 2f48 4000 ec58 ca8f 1500 0000  ..,./H@..X......
//   	0x0010:  1002 9e09 a000 da00 0000 0000 0000 0000  ................
//   	0x0020:  2d58 ca8f 0000 0000 1600 1103 5000 3a01  -X..........P.:.
//   	0x0030:  e2cb 9c50 9a18 e0cb bcb4 8c3a e0cb bcb4  ...P.......:....
//   	0x0040:  8c3a 3054 7f16 bd8a 8902 0000 6400 3114  .:0T........d.1.
//   	0x0050:  0015 4368 6f6f 7365 2041 6e6f 7468 6572  ..Choose.Another
//   	0x0060:  2043 6173 746c 6501 0882 848b 960c 1218  .Castle.........
//   	0x0070:  2403 010b 0706 5553 2001 0b1e 2a01 0030  $.....US....*..0
//   	0x0080:  1401 0000 0fac 0401 0000 0fac 0401 0000  ................
//   	0x0090:  0fac 0280 0032 0430 4860 6c0b 0502 002a  .....2.0H`l....*
//   	0x00a0:  0000 4605 73d0 0100 0c33 0b0c 0102 0304  ..F.s....3......
//   	0x00b0:  0506 0809 0a0b 2d1a ad09 03ff ffff ff00  ......-.........
//   	0x00c0:  0000 0000 0000 0001 0000 0000 0000 0000  ................
//   	0x00d0:  0000 3d16 0b00 0500 0000 0000 0000 0000  ..=.............
//   	0x00e0:  0000 0000 0000 0000 0000 7f08 0410 0f04  ................
//   	0x00f0:  0000 0040 bf0c f279 8b33 aaff 0000 aaff  ...@...y.3......
//   	0x0100:  0000 c005 0000 00fc ffdd 1800 50f2 0201  ............P...
//   	0x0110:  0180 0003 a500 0027 a500 0042 54bc 0062  .......'...BT..b
//   	0x0120:  4366 00dd 0900 037f 0101 0000 ff7f dd0d  Cf..............
//   	0x0130:  0018 0a07 0000 0000 0100 9f3b 05dd 0500  ...........;....
//   	0x0140:  4096 0305 dd05 0040 9614 00dd 0500 4096  @......@......@.
//   	0x0150:  0b20 d925 de8b                           ...%..
var testPacketDot11ProbeResponse = []byte{
	,
}
func TestPacketDot11ProbeResponse(t *testing.T) {
	p := gopacket.NewPacket(testPacketDot11ProbeResponse, LinkTypeIEEE80211Radio, gopacket.Default)
	if p.ErrorLayer() != nil {
		t.Error("Failed to decode packet:", p.ErrorLayer().Error())
	}
	expectedLayers := []gopacket.LayerType{LayerTypeRadioTap, LayerTypeDot11, LayerTypeDot11MgmtProbeResp}
	for i := 0; i < 12; i++ {
		expectedLayers = append(expectedLayers, LayerTypeDot11InformationElement)
	}
	checkLayers(p, expectedLayers, t)
}
func BenchmarkDecodeDot11ProbeResponse(b *testing.B) {
	for i := 0; i < b.N; i++ {
		gopacket.NewPacket(testPacketDot11ProbeResponse, LinkTypeIEEE80211Radio, gopacket.NoCopy)
	}
}
